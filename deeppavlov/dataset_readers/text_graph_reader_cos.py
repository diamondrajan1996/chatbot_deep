...
class TextGraphReaderCos(DatasetReader):
    ...
    def read(self, data_path: str) -> Dict[str, List[Tuple[List[str], int]]]:
        ...
        dataset = {"train": train_data+cos_data, "valid": valid_data, "test": test_data}
